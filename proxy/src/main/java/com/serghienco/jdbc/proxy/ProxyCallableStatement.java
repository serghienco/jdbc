...
public class ProxyCallableStatement<T extends CallableStatement>
        extends ProxyPreparedStatement<T>
        implements CallableStatement {

    public ProxyCallableStatement(
            StatementFactory<T> factory,
            StatementEventListener listener,
            ProxyProducer<Connection> producer) throws SQLException {
        super(factory, listener, producer);
    }
