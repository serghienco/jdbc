...
import com.serghienco.jdbc.proxy.listener.ResultSetEventListener;
...
public class ProxyResultSet implements ResultSet {
    ...
    private final ResultSetEventListener listener;
    private final ResultSet delegate;
    private final ProxyProducer<Statement> producer;

    public ProxyResultSet(
            ResultSetFactory factory,
            ResultSetEventListener listener,
            ProxyProducer<Statement> producer) throws SQLException {
        (this.listener = listener).beforeCreateResultSet();
        this.delegate = Objects.requireNonNull(factory.createResultSet());
        this.producer = Objects.requireNonNull(producer);
    }

    private ResultSetMetaData createProxyResultSetMetaData(ResultSetMetaDataFactory factory) throws SQLException {
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        return createProxyResultSetMetaData(() -> delegate.getMetaData());
    }
    ...
    public Statement getStatement() throws SQLException {
        return producer.getProxyWrap(delegate.getStatement());
    }
