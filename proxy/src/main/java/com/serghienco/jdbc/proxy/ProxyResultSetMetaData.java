...
import com.serghienco.jdbc.proxy.listener.ResultSetMetaDataEventListener;
...
public class ProxyResultSetMetaData implements ResultSetMetaData {
    ...
    private final ResultSetMetaDataEventListener listener;
    private final ResultSetMetaData delegate;

    public ProxyResultSetMetaData(ResultSetMetaDataFactory factory, ResultSetMetaDataEventListener listener)
            throws SQLException {
        (this.listener = listener).beforeCreateResultSetMetaData();
        this.delegate = Objects.requireNonNull(factory.createResultSetMetaData());
    }
